...
int main()
{
	...
	//// Paused
	//int pausedTextPosition[] = { 400, 400 };
	//Text pausedText = helper::MakeText::setParam(font,155,Color::White,pausedTextPosition, "Press Enter \n to continue");

	////Game Over
	//int gameOverTextPosition[] = { 250,850 };
	//Text gameOverText = helper::MakeText::setParam(font,125,Color::White,gameOverTextPosition,"Press Enter to play");
	...
	//	"\n5- More and better health pickups" <<
	//	"\n6- More and better ammo pickups";
	//Text levelUpText = helper::MakeText::setParam(font, 80, Color::White,levelUpPosition ,levelUpstream.str());

	//// Ammo
	//int ammoTextPosition[] = { 200,980 };
	//Text ammotext = helper::MakeText::setParam(font, 55, Color::White, ammoTextPosition);

	//// Score
	//int scoreTextPosition[] = { 20,0 };
	//Text scoreText = helper::MakeText::setParam(font, 55, Color::White, scoreTextPosition);
	...
	//std::stringstream s;
	//s << "Hi Score:" << hiScore;
	//Text hiScoreText = helper::MakeText::setParam(font, 55, Color::White, hiScoreTextPosition, s.str());

	//// Zombies remaining
	//int zombiesRemainingTextPosition[] = { 1500, 980 };
	//Text zombiesRemainingText = helper::MakeText::setParam(font, 55, Color::White, zombiesRemainingTextPosition, "Zombies: 100");

	//// Wave number
	//int wave = 0;
	//int waveNumberTextPosition[] = { 1250,980 };
	//Text waveNumberText = helper::MakeText::setParam(font, 55, Color::White, waveNumberTextPosition, "Wave: 0");
	...
	//Sound hit = SoundEffects::GetSound("sound/hit.wav");
	...
	// Sound splat = SoundEffects::GetSound("sound/splat.wav");
	...
	while (window.isOpen())
	{
		...
		*/
		...
		if (state == State::PLAYING)
		{
			...
			{
				if (helper::Questions::can_I_Fire(gameTimeTotal, lastPressed, fireRate, bulletsInClip))
				{
